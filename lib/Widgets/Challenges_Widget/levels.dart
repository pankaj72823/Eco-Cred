      ...
      data: (challenges) {
        return Column(
          children: [
            ...
            SingleLevelRow(level: 'Easy Level', challenges: challenges['easy']!),
            const SizedBox(height: 30,),
            SingleLevelRow(level: 'Medium Level', challenges: challenges['medium']!),
            const SizedBox(height: 30,),
            SingleLevelRow(level: 'Hard Level', challenges: challenges['hard']!),
          ],
        );
      },
